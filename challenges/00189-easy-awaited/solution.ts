...
type MyAwaitedInternal<P> = P extends PromiseLike<infer U> ? MyAwaitedInternal<U> : P;

type MyAwaited<T extends PromiseLike<any>> = T extends PromiseLike<infer U> ? MyAwaitedInternal<U> : never;  

// type MyAwaited<T extends PromiseLike<any>> = 
//   T extends PromiseLike<infer U>
//     ? U extends PromiseLike<unknown> // true b
//       ? MyAwaited<U> // true b
//         : U // true b
//           : never; // false b
